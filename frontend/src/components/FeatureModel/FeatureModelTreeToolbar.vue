	...
	<div>
		...
		>
			<v-list dense>
				...
				<v-list-item
					:disabled="!isSaveAvailable || !editRights"
					@click="$emit('save')"
				>
					<v-list-item-icon>
						<v-icon v-if="!isSaveAvailable" disabled
							>mdi-content-save</v-icon
						>
						<v-icon v-else :disabled="!editRights"
				...
				>
					<template v-slot:activator="{ on, attrs }">
						...
						>
							...
							<v-list-item-content>
								<v-list-item-title
									>Discard changes</v-list-item-title
								>
							</v-list-item-content>
						</v-list-item>
					</template>
				...
				<v-menu offset-y>
					...
					<v-list>
						...
						>
							<v-list-item-content>
								<v-list-item-title
									>Show Constraints</v-list-item-title
								>
							</v-list-item-content>
						</v-list-item>
						<v-list-item>
