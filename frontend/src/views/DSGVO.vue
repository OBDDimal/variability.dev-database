<template>
    <div>
        ...
        <p>
          ...
          Websitebetreiber Tobias Heß informieren.
        </p>
        <p>
        ...
        <p>
          ...
          Diese Website verwendet ausschließlich technische Cookies die das
          Webseitenerlebnis angenehmer machen. Personenbezogene Cookies werden nicht gesammelt!
        </p>
        <p>
        ...
        <h5 class="text-h5 mb-4">Erfassung und Verarbeitung personenbezogener Daten</h5>
        <p>
        ...
        <p>
          Diese Website können Sie auch besuchen, ohne Angaben zu Ihrer Person zu machen. Zum
...
<script lang="ts">
import Vue from "vue"
import { Cookie, PersonalData } from '../../types'
...
export default Vue.extend({
    ...
    data: () => ({
        cookies: [
            {
                name : 'sessionid',
                purpose: 'Verbessert die Nutzererfahrung, sodass der Nutzer sich bei erneutem Besuch der Website nicht neu anmelden muss.',
                retentionPeriod: '14 Tage'
            },
            {
                name : 'csrftoken',
                purpose: 'Schützt den Nutzer vor Cross-site request forgery (CSRF) Angriffen.',
        ...
        personalData: [
            {
                ...
                typeOfCollection: 'Muss beim Registrieren auf der Website angegeben werden.',
                purpose: 'Zusendung der Authentifizierungs-Mail, zusendung weiterer Bestätigungs-Mails beim Hochladen von Dateien.'
            },
            {
            ...
            {
                typeOfData: 'Institut',
                typeOfCollection: 'Wenn der Nutzer Mitglied eines Universitäts-Instituts ist, kann er dies freiwillig angeben.',
                purpose: 'Präsentation der eigenen Person.'
            },
            {
                typeOfData: 'Mitarbeiter-Flag',
                typeOfCollection: 'Wenn der Nutzer Mitarbeiter der Website ist, wird dies angezeigt.',
