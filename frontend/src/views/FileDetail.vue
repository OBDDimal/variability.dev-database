<template>
  ...
  <v-btn icon>
    ...
    <v-dialog v-model="dialogArtifact" fullscreen transition="dialog-bottom-transition">
      <v-toolbar
          dark
      >
        <v-icon class="mr-2">mdi-file-compare</v-icon>
        <v-toolbar-title>View and compare Feature Model artifacts: <span
            class="font-weight-bold">{{ selectedArtifact.title }}</span></v-toolbar-title>
        <v-spacer></v-spacer>
        <v-toolbar-items>
          <v-btn
              icon
        ...
        <v-card-text>
          <v-row class="ma-1">
            <v-col
                ...
                class="pa-2"
            >
              <h6 class="text-h6">Feature Model: {{ file.label }}</h6>
              ...
              ></v-data-table>
              <div v-else>
                <textarea v-model="xmlFile" style="border:none; width: 100%; height: 500px; color: white">
                </textarea>
              </div>
            </v-col>
            <v-col
            ...
            <v-col v-else cols="12" md="6" lg="6" class="pa-2" style="border-left: 2px solid white;">
              <h6 class="text-h6">
                <v-btn
                    color="inherit"
                    icon
