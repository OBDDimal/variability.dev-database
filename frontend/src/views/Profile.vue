    ...
    >
        <div class="my-10 py-4 d-flex justify-center">
            <v-card elevation="4" max-width="1000px" outlined>
                    ...
                    <v-row align="center">
                        ...
                        <v-col cols="auto">
                            <span v-if="$vuetify.breakpoint.mdAndUp"
                                  class="mb-2 text-h4">{{ $store.state.currentUser.email }}</span>
                ...
                <v-card-text>
                    <v-row align="center">
                        <v-col :class="$vuetify.breakpoint.smAndDown ? 'pb-0' : ''" cols="12" md="2">
                            <h4>User since:</h4>
                        </v-col>
                        <v-col>
                                        ...
                                        <v-row class="pt-1">
                                            ...
                                            <v-col>
                                                ...
                                                <div v-if="elem.type == 'file'">
                                                    <v-btn class="mr-2" color="primary" outlined x-small>
...
export default Vue.extend({
    ...
    computed: {
        preparedElems: function () {
            ...
            const preparedFiles = files.filter(elem => elem.owner).map((elem) => {
                return {id: elem.id, label: elem.label, uploaded_at: elem.uploaded_at, type: "file"}
            })
            const preparedTags = tags.filter(elem => elem.owner).map((elem) => {
                return {id: elem.id, label: elem.label, uploaded_at: elem.date_created, type: "tag"}
            })
