        ...
        <v-card-text>
          ...
          <v-row class="ma-1">
            ...
            >
              <v-container>
                <h6 class="text-h6">
                  Feature Model: {{ props.file.label }}
                </h6>
                <v-data-table
                  v-if="props.selectedArtifact.title === 'CSV'"
...
const emit = defineEmits(['closeCompareView'])
