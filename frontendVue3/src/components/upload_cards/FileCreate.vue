...
&lt;!&ndash;                <v-tab-item> </v-tab-item>&ndash;&gt;
                &lt;!&ndash;          <v-tab-item>
            <v-container>
              <div class="mb-6">
              ...
              >
                <v-row>
                  ...
                  <v-col class="py-0" cols="12" md="6">
                    &lt;!&ndash; Change back to v-combobox when new family upload is working properly &ndash;&gt;
                    <v-text-field
                      v-model="family_bulk"
                      :required="true"
                      dense
                ...
                <v-row>
                  <v-col class="py-0" cols="12">
                    &lt;!&ndash; Change back to v-combobox once sequential axios requests are implemented &ndash;&gt;
                    <v-autocomplete
                      v-model="tags_bulk"
                      :items="getTags"
...
/*watch(family, (newValue) => {
    newFamilyIsObject.value = false;
    if (typeof newValue == 'string') {
      isNewFamily.value = !gottenFamilies.value
        .map((x) => x.text)
        .includes(newValue);
