...
export default class FamilyCreate extends Component<Props, State> {
  ...
  onSubmit = (e: { preventDefault: () => void }) => {
    ...
    if (this.state.label && this.state.description) {
      ...
      api
        .post(`${API_URL}families/`, this.state)
        .then(() => {
          Modal.fire({
            icon: 'success',
            title: 'Success!!',
            text: 'Family was created successfully!',
          }).then(() => {
          ...
          <form onSubmit={this.onSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                placeholder="Leave a family name"
              />
            </Form.Group>
            <Form.Group className="mb-3">
